        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpectedEndAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductionSchedules_AspNetUsers_CreatedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaterialCost = table.Column<decimal>(type: "decimal(12,2)", nullable: false),
                    ...
                    ComputedByUserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductionCosts_AspNetUsers_ComputedByUserId",
                        column: x => x.ComputedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_ProductionCosts_ProductionSchedules_ProductionScheduleId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QualityChecks_AspNetUsers_InspectedByUserId",
                        column: x => x.InspectedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_QualityChecks_ProductionSchedules_ProductionScheduleId",
                        column: x => x.ProductionScheduleId,
                        principalTable: "ProductionSchedules",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductionScheduleId = table.Column<int>(type: "int", nullable: false),
                    WorkOrderNo = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: false),
                    ProcessStep = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MaterialMovements_AspNetUsers_CreatedByUserId",
                        column: x => x.CreatedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MaterialMovements_ProductionSchedules_ProductionScheduleId",
                        column: x => x.ProductionScheduleId,
                        principalTable: "ProductionSchedules",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaterialMovements_CreatedByUserId",
                table: "MaterialMovements",
                column: "CreatedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_MaterialMovements_MaterialId_MovementType",
                table: "MaterialMovements",
                columns: new[] { "MaterialId", "MovementType" });

            migrationBuilder.CreateIndex(
                name: "IX_MaterialMovements_ProductionScheduleId",
                table: "MaterialMovements",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductionCosts_ComputedByUserId",
                table: "ProductionCosts",
                column: "ComputedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductionCosts_ProductionScheduleId",
                table: "ProductionCosts",
                column: "ProductionScheduleId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductionSchedules_Status_ExpectedEndAt",
                table: "ProductionSchedules",
                columns: new[] { "Status", "ExpectedEndAt" });

            migrationBuilder.CreateIndex(
                name: "IX_ProductionSchedules_Status_ScheduleDate",
                table: "ProductionSchedules",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QualityChecks_InspectedByUserId",
                table: "QualityChecks",
                column: "InspectedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_QualityChecks_ProductionScheduleId_Result",
                table: "QualityChecks",
                columns: new[] { "ProductionScheduleId", "Result" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkOrders_ProductionScheduleId_Status",
                table: "WorkOrders",
                columns: new[] { "ProductionScheduleId", "Status" });
